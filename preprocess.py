...
def parse_data(train_path, test_path):
    train_df = pd.read_csv("F:/7.NLP导师名企班/week1-homework/datasets/AutoMaster_TrainSet.csv", encoding='utf-8')
    ...
    test_df = pd.read_csv("F:/7.NLP导师名企班/week1-homework/datasets/AutoMaster_TestSet.csv", encoding='utf-8')
...
if __name__ == '__main__':
    # 需要更换成自己数据的存储地址
    train_path = "F:/7.NLP导师名企班/week1-homework/datasets/AutoMaster_TrainSet01.csv"
    test_path = "F:/7.NLP导师名企班/week1-homework/datasets/AutoMaster_TestSet01.csv"
    parse_data('{}'.format(BASE_DIR),
               '{}'.format(BASE_DIR))
